...
// @match        *://*/admin/parametry-pro-filtrovani-vypis/*
// @match        *://*/admin/parametry-pro-filtrovani-detail/*
...
(async function() {
    ...
    console.log("[SPSorting] Query parametr 'sova_run=1' nalezen. Spouštím skript.");
