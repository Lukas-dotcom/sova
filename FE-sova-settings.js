...
window.additionalSale = [
  ...
  },
  {
    ...
    "pairText": "Výměna disku",
    "type": "select",
    "SOVAL": "(\r\n  ( (category = \"Notebooky\" OR category = \"Počítače\") OR CONTAINS(productCurrentCategory,\"Notebooky\") OR CONTAINS(productCurrentCategory,\"Počítače\") )\r\n  AND (parametroptdisableupgradedisc = \"false\")\r\n  AND NOT CONTAINS(productName,\"All in One\")\r\n  AND NOT CONTAINS(parametrTypdisku,\"eMMC\")\r\n  AND (\r\n    CONTAINS(parametrKapacitadisku,\"+\")\r\n    OR (regexextract(parametrKapacitadisku,\"([0-9]+(?:[.,][0-9]+)?)\") = \"\")\r\n    OR CONTAINS(parametrTypdisku,\"HDD\")\r\n    OR ( 256 > if( CONTAINS(parametrKapacitadisku,\"TB\"),\r\n                    regexextract(parametrKapacitadisku,\"([0-9]+(?:[.,][0-9]+)?)\")*1000,\r\n                    regexextract(parametrKapacitadisku,\"([0-9]+(?:[.,][0-9]+)?)\") ) )\r\n  )\r\n)\r\n"
  },
  {
    "code": "VRP0029",
    "name": "SSD 480GB",
    ...
    "pairText": "Výměna disku",
    "type": "select",
    "SOVAL": "(\r\n  ( (category = \"Notebooky\" OR category = \"Počítače\") OR CONTAINS(productCurrentCategory,\"Notebooky\") OR CONTAINS(productCurrentCategory,\"Počítače\") )\r\n  AND (parametroptdisableupgradedisc = \"false\")\r\n  AND NOT CONTAINS(productName,\"All in One\")\r\n  AND NOT CONTAINS(parametrTypdisku,\"eMMC\")\r\n  AND (\r\n    CONTAINS(parametrKapacitadisku,\"+\")\r\n    OR (regexextract(parametrKapacitadisku,\"([0-9]+(?:[.,][0-9]+)?)\") = \"\")\r\n    OR CONTAINS(parametrTypdisku,\"HDD\")\r\n    OR ( 480 > if( CONTAINS(parametrKapacitadisku,\"TB\"),\r\n                    regexextract(parametrKapacitadisku,\"([0-9]+(?:[.,][0-9]+)?)\")*1000,\r\n                    regexextract(parametrKapacitadisku,\"([0-9]+(?:[.,][0-9]+)?)\") ) )\r\n  )\r\n)\r\n"
  },
  {
    "code": "VRP0016",
    "name": "SSD 512GB",
    ...
    "pairText": "Výměna disku",
    "type": "select",
    "SOVAL": "(\r\n  ( (category = \"Notebooky\" OR category = \"Počítače\") OR CONTAINS(productCurrentCategory,\"Notebooky\") OR CONTAINS(productCurrentCategory,\"Počítače\") )\r\n  AND (parametroptdisableupgradedisc = \"false\")\r\n  AND NOT CONTAINS(productName,\"All in One\")\r\n  AND NOT CONTAINS(parametrTypdisku,\"eMMC\")\r\n  AND (\r\n    CONTAINS(parametrKapacitadisku,\"+\")\r\n    OR (regexextract(parametrKapacitadisku,\"([0-9]+(?:[.,][0-9]+)?)\") = \"\")\r\n    OR CONTAINS(parametrTypdisku,\"HDD\")\r\n    OR ( 512 > if( CONTAINS(parametrKapacitadisku,\"TB\"),\r\n                    regexextract(parametrKapacitadisku,\"([0-9]+(?:[.,][0-9]+)?)\")*1000,\r\n                    regexextract(parametrKapacitadisku,\"([0-9]+(?:[.,][0-9]+)?)\") ) )\r\n  )\r\n)\r\n"
  },
  {
    "code": "VRP0017",
    "name": "SSD 1TB",
    ...
    "pairText": "Výměna disku",
    "type": "select",
    "SOVAL": "(\r\n  ( (category = \"Notebooky\" OR category = \"Počítače\") OR CONTAINS(productCurrentCategory,\"Notebooky\") OR CONTAINS(productCurrentCategory,\"Počítače\") )\r\n  AND (parametroptdisableupgradedisc = \"false\")\r\n  AND NOT CONTAINS(productName,\"All in One\")\r\n  AND NOT CONTAINS(parametrTypdisku,\"eMMC\")\r\n  AND (\r\n    CONTAINS(parametrKapacitadisku,\"+\")\r\n    OR (regexextract(parametrKapacitadisku,\"([0-9]+(?:[.,][0-9]+)?)\") = \"\")\r\n    OR CONTAINS(parametrTypdisku,\"HDD\")\r\n    OR ( 1000 > if( CONTAINS(parametrKapacitadisku,\"TB\"),\r\n                     regexextract(parametrKapacitadisku,\"([0-9]+(?:[.,][0-9]+)?)\")*1000,\r\n                     regexextract(parametrKapacitadisku,\"([0-9]+(?:[.,][0-9]+)?)\") ) )\r\n  )\r\n)\r\n"
  },
  {
    "code": "VRP0018",
    "name": "SSD 2TB",
  ...
  },
  {
    ...
    "pairText": "Výměna disku",
    "type": "select",
    "SOVAL": "(((category = \"Počítače\") OR CONTAINS(productCurrentCategory,\"Počítače\")) AND (parametroptdisableupgradedisc = \"false\") AND NOT CONTAINS(productName,\"All in One\") AND NOT CONTAINS(parametrTypdisku,\"eMMC\") AND (CONTAINS(parametrKapacitadisku,\"+\") OR (regexextract(parametrKapacitadisku,\"([0-9]+(?:[.,][0-9]+)?)\") = \"\") OR (4000 > if(CONTAINS(parametrKapacitadisku,\"TB\"), regexextract(parametrKapacitadisku,\"([0-9]+(?:[.,][0-9]+)?)\")*1000, regexextract(parametrKapacitadisku,\"([0-9]+(?:[.,][0-9]+)?)\")))))"
  }
];
